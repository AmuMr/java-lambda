...
import com.example.javalambda.entity.AClass;
import com.example.javalambda.entity.Data1;
import com.example.javalambda.entity.Data2;
import com.example.javalambda.entity.ListContainer;
import com.example.javalambda.entity.OutputData;
...
//        System.out.println(data1IntersectResult);
    ...
    public void flatMapToIntTest() {
        ...
        listOfLists.stream().flatMapToDouble(s -> s.stream().mapToDouble(Double::new));
